    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" style="background-color: rgba(0, 0, 0, 0.5);">
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="relative bg-white rounded-lg max-w-lg w-full">
                ...
                <!-- Body -->
                <div class="p-5">
                    <form wire:submit.prevent="saveDecharge" class="space-y-4">
                        <div class="space-y-4">
                            @if($selectedCourrier)
                            <div class="bg-gray-50 p-3 rounded-md">
                                <p><strong>Courrier :</strong> {{ $selectedCourrier->numero }}</p>
                            ...
                            <div class="text-sm text-gray-600">
                                <p><strong>Note :</strong> Veuillez scanner la décharge signée par le destinataire et la télécharger ici.</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-5 flex justify-end space-x-3">
                            ...
                            >
                                <span wire:loading.remove wire:target="saveDecharge">Enregistrer</span>
                                <span wire:loading wire:target="saveDecharge">Traitement...</span>
                            </button>
                        </div>
                    </form>
                </div>
