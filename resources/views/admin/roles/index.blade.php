                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            ...
                            @if(!in_array($role->slug, ['admin', 'gestionnaire', 'agent', 'lecteur']) && ($role->users_count ?? 0) == 0)
                            <form action="{{ route('roles.destroy', $role) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce rôle ?');" class="inline">
                                @csrf
                                @method('DELETE')
